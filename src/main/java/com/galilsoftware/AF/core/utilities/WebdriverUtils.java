...
public class WebdriverUtils {
	 ...
	 */
	public static void removeAttributeForElement(WebDriver driver,
			WebElement el, String attributToRemove) {
		((JavascriptExecutor) driver).executeScript(
				"arguments[0].removeAttribute('" + attributToRemove + "')", el);
	}
	...
	public static String getTextInJS(WebDriver driver, WebElement el) {
		return ((JavascriptExecutor) driver).executeScript(
				"return arguments[0].innerText", el).toString();
	}
	...
	public static String getFieldValue(WebDriver driver, WebElement element) {
		...
		String val = (String) ((JavascriptExecutor) driver).executeScript(js,
				element);
		sleep(800);
		val = val.equals("undefined") ? (String) ((JavascriptExecutor) driver)
				.executeScript(jsx, element) : val;
				return val;
	}
	...
	public static void waitForElementInAListToNotHaveClass(WebDriver driver,
			final String classToHave, final By elementLocator, final int index) {
	...
	public static void waitForBudgetaCreateButton(final WebDriver driver) {
		...
		wait.until(new Function<WebDriver, Boolean>() {
			...
			public Boolean apply(WebDriver arg0) {
				try {
					return !driver.findElement(By.id("confirm-btn")).getText().contains("Working");
				} catch (Exception e) {
					return true;
				}
			}
