...
public class TopHeaderBar extends AbstractPOM {
	...
	public boolean isSettingIconDispaly() {

		try {
			return budgetSettings.isDisplayed();
	...
	public boolean isEditTableIconDispaly() {

		try {
			return editTableIcon.isDisplayed();
		} catch (NoSuchElementException e) {
			return false;
		}
	...
	public boolean isScenarioDispaly() {
	...
	public boolean isVersionsDispaly() {

		try {
			return revisions.isDisplayed();
		} catch (NoSuchElementException e) {
			return false;
		}
